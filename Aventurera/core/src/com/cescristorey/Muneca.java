 ...
 * @author Noelia
 */
public class Muneca extends Image{
    TextureRegion stand;
//    Animation walk;
    ...
    final float MAX_VELOCITY = 15f;
    final float DAMPING = 0.87f;

    public Muneca() {
        final float width = (float) 22;
        final float height = 30;
        this.setSize(1, height / width);

        Texture munecaTexture = new Texture("muñeca1.png");
        TextureRegion[][] grid = TextureRegion.split(munecaTexture, (int) width, (int) height);
