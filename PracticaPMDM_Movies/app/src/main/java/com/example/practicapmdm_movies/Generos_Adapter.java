...
import com.example.practicapmdm_movies.Generos.Genre;
 ...
 */
public class Generos_Adapter extends RecyclerView.Adapter<Generos_Adapter.moviesViewHolder> {
    /*
    Atributos
    */
    ...
    private Generos_Adapter.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public Generos_Adapter(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new Generos_Adapter.OnItemClickListener() {
            @Override
