 ...
 */
public class Series_Adapter extends RecyclerView.Adapter<Series_Adapter.moviesViewHolder> {
    /*
    Atributos
    */
    ...
    private Series_Adapter.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public Series_Adapter(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new Series_Adapter.OnItemClickListener() {
            @Override
            public void onItemClick(Result movie) {
                ...
                intent.putExtra("titulo", movie.getName());
                intent.putExtra("puntuacion", String.valueOf(movie.getVoteAverage()));
                intent.putExtra("imagen", String.valueOf(movie.getPosterPath()));
               intent.putExtra("imagen1", String.valueOf(movie.getBackdropPath()));
                intent.putExtra("descripcion", movie.getOverview());
                intent.putExtra("release", movie.getFirstAirDate());
    ...
    */
    ...
    public class moviesViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindMovie(final Result movie, final OnItemClickListener listener) {
            ...
            puntuacion.setRating((float) movie.getVoteCount()/2);
