 ...
 */
public class CreditosSeries_Adapter extends RecyclerView.Adapter<CreditosSeries_Adapter.moviesViewHolder> {
    /*
    Atributos
    */
    ...
    private CreditosSeries_Adapter.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public CreditosSeries_Adapter(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new CreditosSeries_Adapter.OnItemClickListener() {
            @Override
    ...
    */
    ...
    public void onBindViewHolder(moviesViewHolder holder, int position) {
        ...
        final com.example.practicapmdm_movies.CreditosSeries.Cast movie = list.get(position);
