...
import com.example.practicapmdm_movies.GenerosSeries.Genre;
 ...
 */
public class GenerosSeries_Adapter extends RecyclerView.Adapter<GenerosSeries_Adapter.moviesViewHolder> {
    /*
    Atributos
    */
    public final Context context; //Almacena el contexto donde se ejecutará
    private ArrayList<Genre> list; //Almacenará las películas a mostrar
    private GenerosSeries_Adapter.OnItemClickListener listener; //Listener para cuando se haga click
    ...
    Constructor
    */
    public GenerosSeries_Adapter(Context context) {
    ...
    */
    private void setListener () {
        this.listener = new GenerosSeries_Adapter.OnItemClickListener() {
            @Override
    ...
    */
    ...
    public moviesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_genre_item, parent, false);
    ...
    public class moviesViewHolder extends RecyclerView.ViewHolder {
        ...
        public moviesViewHolder(View itemView) {
            super(itemView);
            tvName = (TextView) itemView.findViewById(R.id.textViewGeneros);
